...
namespace XiNghiep.Controllers
{
    public class LeaveRequestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LeaveRequestId,EmployeeId,LeaveType,StartDate,EndDate,Status,ReasonLeave,CreateAt")] LeaveRequest leaveRequest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LeaveRequestId,EmployeeId,LeaveType,StartDate,EndDate,Status,ReasonLeave,CreateAt")] LeaveRequest leaveRequest)
        {
